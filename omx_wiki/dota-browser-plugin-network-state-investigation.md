...
2026-06-27 evidence from `VMRP_E2E_KEEP_TMP=1 ... --reporter=verbose`, temp dir `/tmp/vmrp-e2e-uVkuCx`:
...
Disassembly evidence from `build/vmrp` before the fix:
...
- `cmake --build build --target vmrp -j2` passed with existing warnings.
