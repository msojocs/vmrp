...
- Current loaded frame: `/tmp/vmrp-e2e-1UrKUI/loaded.ppm`; pixel `(100,43)` is `[0,0,0]`, while the expected framebuffer white is `[248,252,248]`.
...
- Current cached conversion `/tmp/vmrp-ws-qR5gkb/mythroad/brw/http/cache3/6788.gif` is an opaque 220x43 GIF, SHA-256 `3b3961cd665aa286b939a882043e689bdf1226f8c558a6f92dc35367a84b10d9`; its former transparent canvas pixels are opaque black.
...
- Final loaded frame: `/tmp/vmrp-e2e-0crfJT/loaded.ppm`, SHA-256 `5d55df316c04789ffe490662444ab8af4d276608e3eac6bf8416448d133d0806`.
- PPM proof: `(100,43)=[248,252,248]`, blue logo `(50,72)=[72,144,216]`, red logo `(42,68)=[248,0,0]`, and rightmost glyph `(216,53)=[152,152,152]`.
- Final cached image: `/tmp/vmrp-ws-51gaPf/mythroad/brw/http/cache3/6620.gif`, 220x43, SHA-256 `1d45130453b4b9b0ffa6067cb3fead589d7cc7e63544600e831f703d4abf70da`. All four corners are `[255,255,255,255]`; it has zero transparent pixels and zero opaque-black pixels.
