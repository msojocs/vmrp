...
结果仍失败，保留目录 `/tmp/vmrp-e2e-cRvO3g`。失败点仍是
...
结果仍失败，保留目录 `/tmp/vmrp-e2e-yiJkxm`。PPM 形态未变：
...
当前必须以运行时 dump 为准。`/tmp/vmrp-internal-0x2D0578-148224.bin`
的 SHA256 是 `1978f27d90887ae9398aef643b95d9fe61b5e5c2bceeb4c70cb1d121eb5a92de`；
而 `/tmp/brwcore.ext`、`/tmp/vmrp-brwcore.ext` 和子代理提取的
`/tmp/vmrp-readonly-disasm-46407/brwcore_brwcore.ext` 都是
...
精确反汇编 brwcore 解码镜像 (/tmp/vmrp-internal-0x2D0578-148224.bin, base 0x2D0578):
