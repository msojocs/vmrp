 ...
 * </code>
 *****************************************************************************/
#define applib_mem_ap_alloc(app_id, mem_size) applib_mem_ap_alloc_int(app_id, mem_size, ASM_ALLOC_DEFAULT_FLAG, __FILE__, __LINE__, KAL_FALSE)
 ...
 * </code>
 *****************************************************************************/
#define applib_mem_ap_alloc_sw(app_id, mem_size) applib_mem_ap_alloc_int(app_id, mem_size, ASM_ALLOC_IS_SW_FLAG, __FILE__, __LINE__, KAL_FALSE)
 ...
 *  Allocated memory block
 *****************************************************************************/
#define applib_mem_ap_alloc_framebuffer(app_id, mem_size) applib_mem_ap_alloc_int(app_id, mem_size, ASM_ALLOC_IS_FB_FLAG, __FILE__, __LINE__, KAL_FALSE)
 ...
 *  Allocated memory block
 *****************************************************************************/
#define applib_mem_ap_alloc_framebuffer_in_top(app_id, mem_size) applib_mem_ap_alloc_int(app_id, mem_size, ASM_ALLOC_IS_FB_FLAG|ASM_ALLOC_IS_TOP_FLAG, __FILE__, __LINE__, KAL_FALSE)
#endif
/*****************************************************************************
 * FUNCTION
...
/*****************************************************************************
 * FUNCTION
 *  applib_mem_ap_register_allocation_fail_handler
 * DESCRIPTION
 *  register allocation fail handler. When allocate memory fail, if it's screen group allocate
 *  memory, framework will invoke this function automaticlly.
 * PARAMETERS
 *  handler :      [IN]        allocation fail handler
 * RETURNS
 *  previous allocation fail handler
 *****************************************************************************/
extern void applib_mem_ap_register_allocation_fail_handler(
                                                applib_mem_ap_allocation_fail_handler_type handler);
...
extern void applib_mem_screen_deinit(void);
extern void applib_mem_screen_init_2(kal_uint32 (*screen_id_callback)(void),
                kal_uint32 pool_size, 
                void *(* screen_mem_alloc)(kal_int32 size,kal_bool is_framebuffer, kal_char * filename, kal_int32 lineno),
                void ( * screen_mem_free)(void * ptr, kal_char * filename, kal_int32 lineno),
                kal_uint32 (*screen_get_total_left_size)(kal_char * filename, kal_int32 lineno),
                kal_uint32 (*screen_get_max_alloc_size)(kal_char * filename, kal_int32 lineno));
 ...
 *****************************************************************************/
#define applib_asm_alloc_r(_id, _size)   mmi_frm_asm_alloc_int(_id, _size, ASM_ALLOC_DEFAULT_FLAG, __FILE__, __LINE__)
 ...
 *  pointer to allocated memory. NULL if memory is not available.
 *****************************************************************************/
#define applib_asm_alloc_sw_r(_id, _size)   mmi_frm_asm_alloc_int(_id, _size, ASM_ALLOC_IS_SW_FLAG, __FILE__, __LINE__)
 ...
 *  pointer to allocated memory. NULL if memory is not available.
 *****************************************************************************/
#define mmi_frm_asm_alloc_nc_top_r(_id, _size)   mmi_frm_asm_alloc_int(_id, _size, ASM_ALLOC_IS_FB_FLAG|ASM_ALLOC_IS_TOP_FLAG, __FILE__, __LINE__)
#endif
 ...
 *  pointer to allocated memory. NULL if memory is not available.
 *****************************************************************************/
#define applib_asm_alloc_nc_r(_id, _size)   mmi_frm_asm_alloc_int(_id, _size, ASM_ALLOC_IS_FB_FLAG, __FILE__, __LINE__)
 ...
 *  void
 *****************************************************************************/
#define applib_asm_free_r(_id, _mem_ptr)  mmi_frm_asm_free_int(_id, _mem_ptr, __FILE__, __LINE__)
 ...
 *  void
 *****************************************************************************/
#define applib_mem_ap_cache_alloc(_size, _free_cb) applib_mem_ap_cache_alloc_int(_size, ASM_ALLOC_DEFAULT_FLAG, _free_cb,  __FILE__, __LINE__)
 ...
 *  void
 *****************************************************************************/
#define applib_mem_ap_cache_alloc_sw(_size, _free_cb) applib_mem_ap_cache_alloc_int(_size, ASM_ALLOC_IS_SW_FLAG, _free_cb,  __FILE__, __LINE__)
 ...
 *  void
 *****************************************************************************/
#define applib_mem_ap_cache_alloc_nc(_size, _free_cb) applib_mem_ap_cache_alloc_int(_size, ASM_ALLOC_IS_FB_FLAG, _free_cb,  __FILE__, __LINE__)
 ...
 *  void
 *****************************************************************************/
#define applib_mem_ap_cache_free(_mem_ptr)  applib_mem_ap_cache_free_int(_mem_ptr, __FILE__, __LINE__)
