...
#if defined( __MMI_DSM_NEW__ ) &&!defined(__MED_IN_ASM__)   
#ifndef __MMI_DSM_NEW_JSKY__
    kal_uint8 MED_DSM_EXT_SIZE[5*1024*1024];
#else
    kal_uint8 MED_DSM_EXT_SIZE[6*1024*1024];
#endif
