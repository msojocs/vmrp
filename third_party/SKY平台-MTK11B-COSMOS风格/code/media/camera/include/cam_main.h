...
extern void mr_media_cam_send_data_req(module_type src_mod_id);
extern void mr_media_cam_send_data_rsp(kal_int32 , kal_uint32 );
extern void mr_media_cam_datareq_ind_hdlr(ilm_struct *ilm_ptr);
extern kal_uint8 gMrCam_datareq_ind_flag;
#endif
/* ---- SKY_MULTIMEDIA end ---- */
