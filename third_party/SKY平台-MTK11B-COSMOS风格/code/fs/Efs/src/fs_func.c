...
int FS_OpenLR(const WCHAR * FileName, kal_uint32 Flag, kal_uint32 caller_address)
{
    ...
    fs_util_trace_info1(TRACE_FUNC | MT_TRACE_INFO_WSTR, FS_API_FS_OPEN_S, Flag, (void*)FileName);
...
kal_int64 FS_SeekLargeFile(FS_HANDLE FileHandle, kal_int64 Offset, int Whence)
{
   ...
   fs_util_trace_info4(TRACE_FUNC, FS_API_FS_SEEKLARGEFILE_S, (kal_uint32)FileHandle, Offset, Whence, NULL, NULL);
...
int FS_CreateDir(const WCHAR * DirName)
{
   ...
   Result = RTFCreateDir(DirName2, NULL);
...
#endif
#else
__align(32) kal_uint32 __pragma(data_seg("_indirect_init_begin")) _indirect_init_begin_p = 0;

#pragma comment(linker, "/MERGE:_indirect_init_content=_indirect_init_begin")

__align(32) kal_uint32 __pragma(data_seg("_indirect_init_end")) _indirect_init_end_p = 0;
...
int FS_OpenHintLR(const WCHAR * FileName, kal_uint32 Flag, FS_FileOpenHint * DSR_Hint, kal_uint32 caller_address)
{
   ...
   if (DSR_Hint != NULL)
      fs_util_trace_info4(TRACE_FUNC | MT_TRACE_INFO_WSTR, FS_API_FS_OPENHINT_S_HINT, Flag, DSR_Hint->Cluster, DSR_Hint->Index, NULL, (void*)FileName);
   else
      fs_util_trace_info1(TRACE_FUNC | MT_TRACE_INFO_WSTR, FS_API_FS_OPENHINT_S, Flag, (void*)FileName);
...
int FS_SetSeekHint(FS_HANDLE FileHandle, kal_uint32 HintNum, FS_FileLocationHint * Hint)
{
   ...
   fs_util_trace_info2(TRACE_FUNC | MT_TRACE_INFO_FILE, FS_API_FS_SETSEEKHINT_S, FileHandle, HintNum, (void*)fs_conf_get_file_by_fh(FileHandle));
...
int FS_FindFirst(const WCHAR * NamePattern, kal_uint8 Attr, kal_uint8 AttrMask, FS_DOSDirEntry * FileInfo, WCHAR * FileName, kal_uint32 MaxLength)
{
    ...
    fs_util_trace_info4(TRACE_FUNC | MT_TRACE_INFO_WSTR, FS_API_FS_FINDFIRST_S, Attr, AttrMask, MaxLength, NULL, (void*)NamePattern);
