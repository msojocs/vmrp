...
static U16 srv_sms_sim_size;
#endif

#ifdef __SRV_SMS_ARCHIVE__
static U16 srv_sms_archive_size;
#endif /* __SRV_SMS_ARCHIVE__ */
...
#endif /* __SRV_SMS_ARCHIVE__ */
static MMI_BOOL srv_sms_get_list_and_size(
                    U16 **msg_id_list,
                    U16 *msg_list_size,
                    srv_sms_box_enum msg_box_type);
 ...
 *  void
 *****************************************************************************/
static MMI_BOOL srv_sms_get_list_and_size(U16 **msg_id_list, U16 *msg_list_size, srv_sms_box_enum msg_box_type)
{
    /*----------------------------------------------------------------*/
    /* Local Variables                                                */
    /*----------------------------------------------------------------*/
 ...
 *  void
 *****************************************************************************/
static void srv_sms_re_create_arch_callback(srv_sms_callback_struct *callback_data)
{
    /*----------------------------------------------------------------*/
    /* Local Variables                                                */
    /*----------------------------------------------------------------*/
    ...
    /* Code Body                                                      */
    /*----------------------------------------------------------------*/
    MMI_TRACE(MMI_COMMON_TRC_G6_MSG, TRC_SRV_SMS_RE_CREATE_ARCH_CALLBACK, callback_data->result);
...
MMI_BOOL dsm_sms_get_list_and_size(U16 **msg_id_list, U16 *msg_list_size, srv_sms_box_enum msg_box_type)
{
   /*----------------------------------------------------------------*/
    /* Local Variables                                                */
    /*----------------------------------------------------------------*/
    ...
    /* Code Body                                                      */
   /*----------------------------------------------------------------*/
   MMI_TRACE(MMI_COMMON_TRC_G6_MSG, TRC_SRV_SMS_GET_LIST_AND_SIZE, msg_box_type);
