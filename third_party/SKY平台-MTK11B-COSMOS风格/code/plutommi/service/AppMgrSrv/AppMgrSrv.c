...
extern srv_appfactory_func_table_struct mrp_appfactory_func_table;
#endif

static appmgr_table_struct _table[] ={
   #ifdef __MMI_DSM_NEW__         
        {SRV_MRP_APPFACTORY_PREFIX,  SRV_APPMGR_MRP_APP_PACKAGE_TYPE,     &mrp_appfactory_func_table},
    #endif    
...
static mmi_app_package_char *_launching_app_name = NULL;
 ...
 * Local functions
 ****************************************************************************/
mmi_app_package_char* srv_appmgr_query_launching_app_name(void)
{
    /*----------------------------------------------------------------*/
    /* Local Variables                                                */
    /*----------------------------------------------------------------*/
