...
extern int32 mr_attributes(const char* filename);
extern int32 mr_setattributes(const char* filename,uint8  attr);
extern int32 mr_getfoldersize(const char* dir);
