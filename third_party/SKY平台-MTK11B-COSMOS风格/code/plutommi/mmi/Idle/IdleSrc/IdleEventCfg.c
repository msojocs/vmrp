...
#if defined(__DM_FOTA_SUPPORT__)
#include "dmuigprot.h"
#endif
...
#if defined(__MMI_DSM_NEW__)  && defined( __PME_SUPPORT__)
extern unsigned char pme_check_new_msg(void);
extern void pme_show_new_msg_ind(void);
#endif
...
#endif /* defined(__DM_FOTA_SUPPORT__) */
...
#if defined(__MMI_PHB_ICE_CONTACT__)
    MMI_IDLE_EVENT_ADD(
        mmi_phb_ice_contact_check,
        mmi_phb_entry_ice_contact
    ),
#endif /* defined(__MMI_PHB_ICE_CONTACT__) */
