...
static MMI_BOOL wgui_status_icon_bar_freeze_ani = MMI_FALSE;
#endif
...
#ifdef __MMI_DUAL_SIM_MASTER__
    {STATUS_ICON_SMS_FULL_SIM, IMG_SI_MASTER_SMS_FULL, GUI_STATUS_ICON_BAR_ICON_NO_GROUP},
    {STATUS_ICON_SLAVE_SMS_FULL, IMG_SI_SLAVE_SMS_FULL, GUI_STATUS_ICON_BAR_ICON_NO_GROUP},
#else
    {STATUS_ICON_SMS_FULL_SIM, IMG_SI_SMS_FULL_SIM, GUI_STATUS_ICON_BAR_ICON_NO_GROUP},
#endif
    {STATUS_ICON_SMS_FULL, IMG_SI_SMS_FULL, GUI_STATUS_ICON_BAR_ICON_NO_GROUP},
...
//#endif /* (defined(MMI_MAX_SIM_NUM) && (MMI_MAX_SIM_NUM >= 3)) */
...
#endif
#ifdef __MMI_DSM_NEW__//放在sublcd start之前
    {STATUS_ICON_DSM_ONLINE, IMG_DSM_STATUS_ICON_ONLINE, GUI_STATUS_ICON_BAR_ICON_NO_GROUP},
    {STATUS_ICON_DSM_AWAY, IMG_DSM_STATUS_ICON_AWAY, GUI_STATUS_ICON_BAR_ICON_NO_GROUP},
    {STATUS_ICON_DSM_HIDE, IMG_DSM_STATUS_ICON_HIDE, GUI_STATUS_ICON_BAR_ICON_NO_GROUP},
    {STATUS_ICON_DSM_OFFLINE, IMG_DSM_STATUS_ICON_OFFLINE, GUI_STATUS_ICON_BAR_ICON_NO_GROUP},
    {STATUS_ICON_DSM_QQ_ONLINE, IMG_DSM_STATUS_ICON_QQ_ONLINE, GUI_STATUS_ICON_BAR_ICON_NO_GROUP},
    {STATUS_ICON_DSM_QQ_AWAY, IMG_DSM_STATUS_ICON_QQ_AWAY, GUI_STATUS_ICON_BAR_ICON_NO_GROUP},
    {STATUS_ICON_DSM_QQ_HIDE, IMG_DSM_STATUS_ICON_QQ_HIDE, GUI_STATUS_ICON_BAR_ICON_NO_GROUP},
    {STATUS_ICON_DSM_QQ_OFFLINE, IMG_DSM_STATUS_ICON_QQ_OFFLINE, GUI_STATUS_ICON_BAR_ICON_NO_GROUP},
#ifdef __SKY_SECURITY_GUARD__
	{STATUS_ICON_SG_MESSAGE, IMG_ID_SKY_SG_STATUS_ICON, GUI_STATUS_ICON_BAR_ICON_NO_GROUP},
#endif

#ifdef __PME_SUPPORT__//放在sublcd start之前
	{STATUS_ICON_PME_SYS, IMG_PME_STATUS_ICON_SYS, GUI_STATUS_ICON_BAR_ICON_NO_GROUP},
	{STATUS_ICON_PME_EMAIL, IMG_PME_STATUS_ICON_EMAIL, GUI_STATUS_ICON_BAR_ICON_NO_GROUP},
	{STATUS_ICON_PME_IM, IMG_PME_STATUS_ICON_IM, GUI_STATUS_ICON_BAR_ICON_NO_GROUP},
#endif
#endif/*__MMI_DSM_NEW__*/
    ...
    {STATUS_ICON_CONTACTS_IMPORT, IMG_SI_CONTACTS_IMPORT, GUI_STATUS_ICON_BAR_ICON_CONTACT_GROUP},
    {STATUS_ICON_CONTACTS_RESTORE, IMG_SI_CONTACTS_RESTORE, GUI_STATUS_ICON_BAR_ICON_NO_GROUP},
    {STATUS_ICON_CONTACTS_SYNC, IMG_SI_CONTACTS_SYNC, GUI_STATUS_ICON_BAR_ICON_CONTACT_GROUP},
...
static MMI_BOOL wgui_status_icon_bar_whether_have_blink_or_animate_icon(void)
{
         ...
         bar_id++)
    {
        ...
        {
            for (i = 0; i < bar->n_events; i++)
            {
                if ((wgui_status_icon_bar_icons[bar->show_events[i]].flags & GUI_STATUS_ICON_BAR_ICON_ANIMATE) ||
                    (wgui_status_icon_bar_icons[bar->show_events[i]].flags & GUI_STATUS_ICON_BAR_ICON_BLINK))
                {
                    return MMI_TRUE;
                }
            }
...
static void wgui_status_icon_bar_icon_blink_and_animate_timer_callback(void)
{
    ...
    {
        wgui_status_icon_bar_freeze_ani = MMI_TRUE;
    }
#endif
...
#endif
#ifdef __MMI_STATUS_ICONBAR_COSMOS_STYLE__
    if (!wgui_status_icon_bar_freeze_ani)
    {
        wgui_status_icon_bar_update();
        gui_start_timer(
...
#ifdef __MMI_STATUS_ICONBAR_COSMOS_STYLE__
    if (!wgui_status_icon_bar_freeze_ani && wgui_status_icon_bar_bars[WGUI_STATUS_ICON_BAR_H_BAR].venus_update_screen_callback_need_redraw)
    {
        wgui_status_icon_bar_bars[WGUI_STATUS_ICON_BAR_H_BAR].venus_update_screen_callback_need_redraw(wgui_status_icon_bar_bars[WGUI_STATUS_ICON_BAR_H_BAR].venus_update_screen_handle);
    }
    wgui_status_icon_bar_freeze_ani = MMI_FALSE;
#endif
}
...
void wgui_status_icon_bar_initialize(void)
{
    ...
    bar->n_sms_full = 0;
#endif
#if (defined(__MMI_FTE_SUPPORT__) && defined(MMI_MAX_SIM_NUM) && (MMI_MAX_SIM_NUM >= 2))
    bar->new_icon_id = -1;
#endif
    ...
    {
        bar = &wgui_status_icon_bar_bars[WGUI_STATUS_ICON_BAR_H_BAR];
        show_icons = (bar->width / 2 -  WGUI_STATUS_ICON_BAR_MAINLCD_CENTER_WIDTH / 2) / wgui_status_icon_bar_icons[STATUS_ICON_SILENT].width;
        show_icons --;
        if (old_width >= bar->width)
        {
            if (bar->n_all_events > show_icons)
            {
                bar->hide_events += (bar->n_events - show_icons);
                bar->n_events = show_icons;
                bar->show_events[show_icons] = 0;
            }
        }
        else
        {
            while (bar->hide_events)
            {
                for (i = bar->n_all_events - 1; i >= 0; i--)
                {
                    for (j = 0; j < bar->n_events; j++)
                    {
                        if (bar->show_events[j] == bar->all_show_events[i])
                            break;
                    }
                    if (j == bar->n_events)
                        break;
                }
                i = bar->all_show_events[i];
                if (i < STATUS_ICON_MAINLCD_LEFT_REGION_END && i > STATUS_ICON_MAINLCD_LEFT_REGION_START && j == bar->n_events)
                {
                    bar->show_events[bar->n_events ] = i;
                    bar->n_events ++;
                }
                bar->hide_events --;
                if (bar->n_events == show_icons)
                {
                    break;
                }
            }
...
void wgui_status_icon_bar_update(void)
{
         ...
         bar_id++)
    {
        ...
        #ifdef __MMI_VUI_ENGINE__
        #ifdef __MMI_STATUS_ICONBAR_COSMOS_STYLE__
            if ((bar_id == WGUI_STATUS_ICON_BAR_H_BAR) &&  !wgui_status_icon_bar_freeze_ani &&
                (wgui_status_icon_bar_bars[bar_id].venus_update_screen_callback != NULL))
            {
                wgui_status_icon_bar_bars[bar_id].venus_update_screen_callback(wgui_status_icon_bar_bars[bar_id].venus_update_screen_handle);
            }
            else if (!wgui_status_icon_bar_freeze_ani)
            {
        #else
            if ((bar_id == WGUI_STATUS_ICON_BAR_H_BAR) &&
                (wgui_status_icon_bar_bars[bar_id].venus_update_screen_callback != NULL))
    ...
    if (g_balloon_need_update)
    {
        ...
        if (wgui_status_icon_bar_bars[WGUI_STATUS_ICON_BAR_H_BAR].venus_update_screen_callback_need_redraw)
        {
            wgui_status_icon_bar_bars[WGUI_STATUS_ICON_BAR_H_BAR].venus_update_screen_callback_need_redraw(wgui_status_icon_bar_bars[WGUI_STATUS_ICON_BAR_H_BAR].venus_update_screen_handle);
        }
...
void wgui_status_icon_bar_reset(void)
{
         ...
         bar_id++)
    {
        ...
        if (wgui_status_icon_bar_bars[bar_id].target_lcd == active_lcd)
        {
            ...
            wgui_status_icon_bar_register_venus_update_callback(NULL, NULL, NULL, NULL, NULL);
...
void wgui_status_icon_bar_register_venus_update_callback(
        ...
        void (*update_screen_callback_need_redraw)(void *handle),
        void (*enter_ncenter)(void*),
        void (*leave_ncenter)(void*),
        void *update_screen_handle)
{
    ...
    gui_status_icon_bar_register_venus_update(
        ...
        update_screen_callback_need_redraw,
        enter_ncenter,
        leave_ncenter,
...
void wgui_status_icon_bar_set_icon_display(S32 icon_id)
{
    ...
    /*----------------------------------------------------------------*/
#ifdef __MMI_STATUS_ICONBAR_COSMOS_STYLE__
	S32 i, missed_id, show_icons, missed_all_id, j;
	gui_status_icon_bar_struct *bar;
    MMI_BOOL is_shown;
#endif /* __MMI_STATUS_ICONBAR_COSMOS_STYLE__ */
	...
	if (icon_id > STATUS_ICON_MAINLCD_LEFT_REGION_START && icon_id < STATUS_ICON_MAINLCD_LEFT_REGION_END)
	{
        ...
        if (i <= bar->n_events - 1)
        {
            while(i > 0)
            {
                bar->show_events[i] = bar->show_events[i - 1];
                i--;
            }
            bar->show_events[0] = icon_id;
        }
        else
        {
            if (bar->n_events == show_icons)
            {
                missed_id = 0;
                missed_all_id = bar->n_all_events - 1;
                for (i = 0; i < bar->n_events; i++)
                {
                    if (bar->show_events[i] > STATUS_ICON_MAINLCD_HIGE_END)
                    {
                        for (j = 0; j < bar->n_all_events; j++)
                        {
                            if (bar->show_events[i] == bar->all_show_events[j])
                            {
                                break;
                            }
                        }
                ...
                if (missed_all_id == bar->n_all_events)
                {
                    missed_id = bar->n_events - 1;
                }
            }
            else if (bar->n_events != 0)
            { 
                missed_id = bar->n_events;
            }
            else
            {
                missed_id = 0;
...
void wgui_status_icon_bar_reset_icon_display(S32 icon_id)
{
    ...
    /*----------------------------------------------------------------*/
#ifdef __MMI_STATUS_ICONBAR_COSMOS_STYLE__
	S32 i, j = 0, show_icons;
	gui_status_icon_bar_struct *bar;
    MMI_BOOL b_remove = MMI_FALSE;
#endif /* __MMI_STATUS_ICONBAR_COSMOS_STYLE__ */
	...
	if (icon_id > STATUS_ICON_MAINLCD_LEFT_REGION_START && icon_id < STATUS_ICON_MAINLCD_LEFT_REGION_END)
	{
        ...
        if (i < bar->n_events)
        {
            while (i < bar->n_events - 1)
            {
                bar->show_events[i] = bar->show_events[i + 1];
                i++;
            }
            bar->n_events --;
            bar->show_events[bar->n_events] = 0;
        }
        for (i = 0; i < bar->n_all_events; i++)
	    {
		    if (bar->all_show_events[i] == icon_id)
	            {
		        if (bar->hide_events && b_remove == MMI_FALSE)
			{
			    bar->hide_events --;
			}
			break;
    ...
    if (b_remove == MMI_TRUE)
    {
        ...
        if (i < STATUS_ICON_MAINLCD_LEFT_REGION_END && i > STATUS_ICON_MAINLCD_LEFT_REGION_START && j == bar->n_events)
        {
            ...
            if (bar->hide_events)
            {
                bar->show_events[bar->n_events - 1] = i;
                bar->hide_events --;
            }
        }
    }
...
void wgui_status_icon_bar_change_icon_level(S32 icon_id, S32 level)
{
        ...
        )
    {
        ...
        {
#if (defined(MMI_MAX_SIM_NUM) && (MMI_MAX_SIM_NUM >= 4))
            if (icon_id > STATUS_ICON_SIM4_SIGNAL_STRENGTH || icon_id == STATUS_ICON_BATTERY_STRENGTH)
            {
                wgui_status_icon_bar_refresh_fixed_icon(WGUI_STATUS_ICON_BAR_H_BAR, icon_id);
            }
#elif (defined(MMI_MAX_SIM_NUM) && (MMI_MAX_SIM_NUM >= 3))
            if (icon_id > STATUS_ICON_SIM3_SIGNAL_STRENGTH || icon_id == STATUS_ICON_BATTERY_STRENGTH)
            {
                wgui_status_icon_bar_refresh_fixed_icon(WGUI_STATUS_ICON_BAR_H_BAR, icon_id);
            }
#else
...
mmi_ret wgui_status_icon_bar_tap_proc(mmi_event_struct* para)
{
    ...
    /* Code Body                                                      */
    /*----------------------------------------------------------------*/
    vapp_ncenter_entry(wgui_status_icon_bar_bars[WGUI_STATUS_ICON_BAR_H_BAR].venus_update_screen_handle);
...

{
    ...
    /*----------------------------------------------------------------*/
    bar = &wgui_status_icon_bar_bars[WGUI_STATUS_ICON_BAR_H_BAR];
    if (bar->venus_enter_ncenter)
    {
        bar->venus_enter_ncenter(bar->venus_update_screen_handle);
    }
    else
    {
        wgui_status_icon_bar_hide_events();
...

{
    ...
    bar = &wgui_status_icon_bar_bars[WGUI_STATUS_ICON_BAR_H_BAR];
    if (bar->venus_leave_ncenter)
    {
        bar->venus_leave_ncenter(bar->venus_update_screen_handle);
    }
    else
    {
        wgui_status_icon_bar_show_events();
