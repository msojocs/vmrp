...
/*__MMI_DSM_NEW__ start*/
	...
	MSG_ID_SPLAYER_BEGIN,
	MSG_ID_SPLAYER_OPEN,
	MSG_ID_SPLAYER_PLAY,
	MSG_ID_SPLAYER_PAUSE,
	MSG_ID_SPLAYER_STOP,
	MSG_ID_SPLAYER_SEEK,
	MSG_ID_SPLAYER_CLOSE,
	MSG_ID_SPLAYER_GET_DES,
	MSG_ID_SPLAYER_DISPLAY,
	...
	MSG_ID_SPLAYER_END = MSG_ID_SPLAYER_BEGIN + 30,
#endif

#if (defined(__MMI_DSM_NEW__)||defined(__DSM_SPLAYER__)) && defined(__MTK_TARGET__) && defined(MT6255)
	/*audio begin*/
	MSG_ID_SPLAYER_AUDIO_BEGIN,
	MSG_ID_SPLAYER_AUDIO_OPEN,
	MSG_ID_SPLAYER_AUDIO_PLAY,
	MSG_ID_SPLAYER_AUDIO_STOP,
	MSG_ID_SPLAYER_AUDIO_PAUSE,
	MSG_ID_SPLAYER_AUDIO_RESUME,
	MSG_ID_SPLAYER_AUDIO_CALLBACK,
	MSG_ID_SPLAYER_AUDIO_END,
	/*audio end*/
#endif
#if defined(__MMI_DSM_NEW__) && defined(__DSM_MEDIA_EXT_H264_ENCODE__)&& defined(__MTK_TARGET__)
	MSG_ID_MPCHAT_ENCODE_REQ,
	MSG_ID_MPCHAT_ENCODE_CNF,
#endif 
/*__MMI_DSM_NEW__ end*/
/* ---- SKY_MULTIMEDIA end ---- */
