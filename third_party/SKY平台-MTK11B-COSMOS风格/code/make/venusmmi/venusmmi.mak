...
SRC_LIST = venusmmi\framework\ui_core\base\vfx_datatype.c \
           ...
           venusmmi\framework\ui_core\mvc\vfx_image.cpp \
           ...
           venusmmi\framework\ui_core\mvc\vfx_visual.cpp \
           venusmmi\framework\ui_core\mvc\vfx_visual_factory.cpp \
           ...
           venusmmi\visual\cp\vcp_vk.cpp \
           venusmmi\visual\cp\vcp_sel_box.cpp \
...
SRC_LIST += venusmmi\visual\cp\vcp_symbol_picker.cpp
...
SRC_LIST += venusmmi\visual\cp\vcp_activity_indicator.cpp \
           venusmmi\visual\cp\vcp_progress_indicator.cpp \
           venusmmi\visual\cp\vcp_info_balloon.cpp \
           venusmmi\visual\cp\vcp_base_picker.cpp \
           venusmmi\visual\cp\vcp_date_picker.cpp \
           venusmmi\visual\cp\vcp_time_picker.cpp \
           venusmmi\visual\cp\vcp_tool_bar.cpp \
           venusmmi\visual\cp\vcp_function_bar.cpp \
           venusmmi\visual\cp\vcp_panel_bar.cpp \
           venusmmi\visual\cp\vcp_slider.cpp \
           venusmmi\visual\cp\vcp_loading_popup.cpp \
           venusmmi\visual\cp\vcp_menu_popup.cpp \
           venusmmi\visual\cp\vcp_indicator_popup.cpp \
           venusmmi\visual\cp\vcp_tab_title_bar.cpp \
           venusmmi\visual\cp\vcp_tabctrl_page.cpp \
           venusmmi\visual\cp\vcp_form.cpp \
           venusmmi\visual\cp\vcp_navi_title_bar.cpp \
           venusmmi\visual\cp\vcp_button_util.cpp \
           venusmmi\visual\cp\vcp_menu_seek_bar.cpp \
           venusmmi\visual\cp\vcp_page_grid.cpp \
           venusmmi\visual\cp\vcp_contact_selector.cpp \
           venusmmi\visual\cp\vcp_photo_border_frame.cpp
endif           

SRC_LIST +=venusmmi\visual\cp\vcp_scrollable.cpp \
           venusmmi\visual\cp\vcp_clock.cpp \
           venusmmi\visual\cp\vcp_button.cpp \
           venusmmi\visual\cp\vcp_button_internal.cpp \
           venusmmi\visual\cp\vcp_marquee.cpp \
           venusmmi\visual\cp\vcp_pluto_control.cpp \
           venusmmi\visual\cp\vcp_softkey.cpp \
           venusmmi\visual\cp\vcp_status_icon_bar.cpp \
           venusmmi\visual\cp\vcp_title_bar.cpp \
           venusmmi\visual\cp\vcp_command_title.cpp \
           venusmmi\app\pluto_variation\ShellApp\panel\HomeScreen\vcp_idle_calendar.cpp \
           venusmmi\visual\cp\effect\vcp_squeeze_filter.cpp \
           venusmmi\visual\cp\effect\vcp_jelly_filter.cpp \
           venusmmi\visual\cp\vcp_shortcut.cpp \
           venusmmi\visual\cp\vcp_base_menu.cpp \
           venusmmi\visual\cp\vcp_var_height_menu.cpp \
           venusmmi\visual\cp\vcp_page_panel.cpp \
           venusmmi\visual\cp\vcp_page_panel_3d.cpp \
           venusmmi\visual\cp\vcp_frame_effect.cpp \
           venusmmi\visual\cp\vcp_frame_effect_3d.cpp \
           venusmmi\visual\cp\vcp_sse.cpp \
           venusmmi\visual\cp\vcp_wheel_menu.cpp \
           venusmmi\visual\cp\vcp_image_button.cpp \
           venusmmi\visual\cp\vcp_tab_bar.cpp \
           venusmmi\visual\cp\vcp_segment_button.cpp \
           venusmmi\visual\cp\vcp_switch.cpp \
           venusmmi\visual\cp\vcp_option_menu.cpp \
           venusmmi\visual\cp\vcp_confirm_popup.cpp \
           venusmmi\visual\cp\vcp_command_popup.cpp \
           venusmmi\visual\cp\vcp_question_popup.cpp \
           venusmmi\visual\cp\vcp_input_popup.cpp \
           venusmmi\visual\cp\vcp_alert_popup.cpp \
           venusmmi\visual\cp\vcp_select_popup.cpp \
           venusmmi\visual\cp\vcp_more_command_popup.cpp \
           venusmmi\visual\cp\vcp_waiting_popup.cpp \
           venusmmi\visual\cp\vcp_global_popup.cpp \
           venusmmi\visual\cp\vcp_list_menu.cpp \
           venusmmi\visual\cp\vcp_state_image.cpp \
           venusmmi\visual\cp\vcp_content_clone.cpp \
           venusmmi\visual\cp\vcp_waiting_icon.cpp \
           venusmmi\visual\cp\vcp_text_editor.cpp \
           venusmmi\visual\cp\vcp_text_layout.cpp \
           venusmmi\visual\cp\vcp_text_storage.cpp \
           venusmmi\visual\cp\vcp_text_utils.cpp \
           venusmmi\visual\cp\vcp_text_view.cpp \
           venusmmi\visual\cp\vcp_bubble_effect.cpp \
           venusmmi\visual\cp\vcp_async_image_frame.cpp \
           venusmmi\visual\custom\mtk\vcp_release_fading_visual.cpp \
           venusmmi\visual\custom\mtk\vcp_scrollbar_bg_visual.cpp \
           venusmmi\visual\custom\mtk\vcp_scrollbar_button_visual.cpp \
           venusmmi\visual\custom\mtk\vcp_scrollbar_cursor_visual.cpp \
           venusmmi\visual\custom\mtk\vfx_visual_factory_mtk.cpp \
           venusmmi\visual\custom\mtk\vcp_switch_visual.cpp \
           venusmmi\visual\custom\mtk\vcp_state_image_visual.cpp \
           venusmmi\visual\custom\mtk\vcp_activity_indicator_visual.cpp \
           venusmmi\visual\custom\vfx_visual_factory_cust.cpp \
           ...
           venusmmi\app\pluto_variation\adapter\CubeApp\vadp_p2v_cube.cpp \
           venusmmi\app\pluto_variation\adapter\CubeApp\vadp_v2p_cube.c \
           venusmmi\app\pluto_variation\adapter\CubeApp\vadp_cube_imgview.c \
...
ifneq ($(filter __PLUTO_MMI_PACKAGE__, $(strip $(MODULE_DEFS))),)
    ...
    ifneq ($(filter __MMI_VUI_SHELL_CP__,$(strip $(MODULE_DEFS))),)
    SRC_LIST += venusmmi\visual\cp\vcp_inline_menu.cpp
    endif
    ...
    ifneq ($(filter __MMI_VUI_WIDGET_KEY_SNS__, $(strip $(MODULE_DEFS))),)
    SRC_LIST += venusmmi\app\pluto_variation\LauncherKey\Widget\SNS\vapp_widget_sns.cpp
    endif
...
#ifneq ($(filter __MMI_VUI_HOMESCREEN_LIVE_WALLPAPER_SHUIMO__,$(strip $(MODULE_DEFS))),)
SRC_LIST += venusmmi\app\common\wallpaper\vapp_wallpaper_shuimo.cpp
#endif

#ifneq ($(filter __MMI_VUI_HOMESCREEN_LIVE_WALLPAPER_AQUARIUM__,$(strip $(MODULE_DEFS))),)
SRC_LIST += venusmmi\app\common\wallpaper\vapp_wallpaper_aquarium.cpp
#endif

#ifneq ($(filter __MMI_VUI_HOMESCREEN_LIVE_WALLPAPER_LAKELEAF__,$(strip $(MODULE_DEFS))),)
SRC_LIST += venusmmi\app\common\wallpaper\vapp_wallpaper_lakeleaf.cpp
#endif
...
SRC_LIST += venusmmi\app\common\widget\vapp_widget_system.cpp \
            venusmmi\app\common\widget\vapp_widget_setting_provider.cpp \
...
INC_DIR = venusmmi\vrt\interface \
          ...
          venusmmi\app\pluto_variation\LauncherKey\widget\SNS \
