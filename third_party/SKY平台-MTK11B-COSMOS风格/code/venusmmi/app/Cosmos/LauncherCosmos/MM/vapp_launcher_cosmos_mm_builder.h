...
private:
    ...
    VfxTimer                            *m_delayCreateCounterTimer;

// Implementation
private:
    void updateEditMode(VfxBool editMode);
    void updateAppCounter(VfxS32 appCounter);

    VfxBool isEditModeTransitioning();
    
    void onDelayCreateCounterTimerTick(VfxTimer *source);
...
public:
    ...
    void loadMenu(VappLauncherCosmosMmPageMenu *menu);
...
// Implementation
private:
    void initFrames(VappLauncherCosmosMmPageMenu *menu);
