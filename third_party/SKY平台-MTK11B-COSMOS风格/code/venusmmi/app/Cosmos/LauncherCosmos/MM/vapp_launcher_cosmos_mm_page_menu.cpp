...
static const VfxS32 VAPP_LAUNCHER_COSMOS_MM_BIG_SWIPE_SPEED_THRESHOLD = 1000;
...
#endif
static const VfxS32 VAPP_LAUNCHER_COSMOS_MM_ANIMTIME_INSTANT_3 = 3;

static const VfxS32 VAPP_LAUNCHER_COSMOS_MM_LONG_PRESS_ENTER_ORGANIZE_DELAY = 1000;
static const VfxS32 VAPP_LAUNCHER_COSMOS_MM_LONG_PRESS_ORGANIZE_ANOTHER_DELAY = 300;
static const VfxS32 VAPP_LAUNCHER_COSMOS_MM_ORGANIZE_AUTO_SCROLL_CD = 2000;
static const VfxS32 VAPP_LAUNCHER_COSMOS_MM_ORGANIZE_AUTO_SCROLL_MARGIN = 30;
static const VfxS32 VAPP_LAUNCHER_COSMOS_MM_HOVER_DELAY = 200;
...
static const VfxS32 VAPP_LAUNCHER_COSMOS_MM_INDICATOR_HEIGHT = 30;
static const VfxS32 VAPP_LAUNCHER_COSMOS_MM_INDICATOR_BG_HEIGHT = 30;
...
static const VfxS32 VAPP_LAUNCHER_COSMOS_MM_MIDIUM_SWIPE_RANGE_THRESHOLD = 200;
static const VfxS32 VAPP_LAUNCHER_COSMOS_MM_BIG_SWIPE_RANGE_THRESHOLD = 20000; // 20000 : disable big swipe
...
static const VfxS32 VAPP_LAUNCHER_COSMOS_MM_INDICATOR_HEIGHT = 20;
static const VfxS32 VAPP_LAUNCHER_COSMOS_MM_INDICATOR_BG_HEIGHT = 20;
...
static const VfxS32 VAPP_LAUNCHER_COSMOS_MM_MIDIUM_SWIPE_RANGE_THRESHOLD = 80;
static const VfxS32 VAPP_LAUNCHER_COSMOS_MM_BIG_SWIPE_RANGE_THRESHOLD = 20000; // 20000 : disable big swipe
...
static const VfxS32 VAPP_LAUNCHER_COSMOS_MM_SWIPE_RANGE_THRESHOLD = 30;
static const VfxS32 VAPP_LAUNCHER_COSMOS_MM_MIDIUM_SWIPE_RANGE_THRESHOLD = 100;
static const VfxS32 VAPP_LAUNCHER_COSMOS_MM_BIG_SWIPE_RANGE_THRESHOLD = 20000; // 20000 : disable big swipe
...
void VappLauncherCosmosMmPageMenu::leaveOrganizationMode()
{
    if (!getOrganizeMode() )
    {
        return;
...
void VappLauncherCosmosMmPageMenu::setEnableMenuAnim(VfxBool enable)
{
...
void VappLauncherCosmosMmPageMenu::setPageCount(VfxS32 pageCount)
{
    ...
    {
        scrollToPage(getPageCount() - 1, VAPP_LAUNCHER_COSMOS_MM_ORGANIZE_DURATION);
    }
}
...
void VappLauncherCosmosMmPageMenu::onDelayLoadCellTimerTick(VfxTimer *source)
{
    ...
    for (VfxS32 i = 0; i < getMenuItemCountPerPage(); ++i)
    {
        ...
        {
            m_cells[cellIndex]->setCacheMode(VFX_CACHE_MODE_FORCE);
    ...
    tl->setTarget(this);
    tl->setTargetPropertyId(VRT_FRAME_PROPERTY_ID_FILTER_TIMING);
    tl->setDurationTime(VAPP_LAUNCHER_COSMOS_MM_ANIMTIME_INSTANT_3);
    tl->setFromValue(0.01f);
    tl->setToValue(0.0f);
    tl->m_signalStopped.connect(this, &VappLauncherCosmosMmPageMenu::onTimelineStop);
    tl->start();
...
void VappLauncherCosmosMmPageMenu::scrollToPage(VfxS32 pageIndex, VfxS32 animTime)
{
    if (pageIndex == -1)
    {
        // special case handling : no item on pages
...
void VappLauncherCosmosMmPageMenu::updateCellsCacheMode()
{
    for (VfxS32 i = 0; i < VAPP_LAUNCHER_COSMOS_MM_MAX_APP; ++i)
    {
        if (m_cells[i] != NULL)
    ...
    if (!m_menuView->isTransitioning() )
    {
        ...
        if (getHover().index != MAINMENU_HITTEST_NOT_FOUND)
        {
            ...
            if (getOrganizeMode() )
            {
								...
								VappLauncherCosmosMmCell* cell = (VappLauncherCosmosMmCell*)getCell(pos);
...
void VappLauncherCosmosMmPageMenu::switchOrganizePage(VfxS32 newPage, VfxS32 touchX, VfxS32 touchY)
{
    ...
    VcpPageMenuCellPos currentDirectPos = cellHittest(VfxPoint(touchX, touchY), VFX_FALSE);
...
void VappLauncherCosmosMmPageMenu::handleOrganizePut()
{
...
void VappLauncherCosmosMmPageMenu::handleOrganizeEnd()
{
...
void VappLauncherCosmosMmPageMenu::compactPages()
{
    m_menuView->setAnimDirty(VAPP_LAUNCHER_COSMOS_MM_ORGANIZE_DURATION * 2);
    ...
    scrollToPage(pageIndexAfterCompact, VAPP_LAUNCHER_COSMOS_MM_ORGANIZE_DURATION);
