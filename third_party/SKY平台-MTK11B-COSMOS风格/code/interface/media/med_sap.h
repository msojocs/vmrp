 ...
 *******************************************************************************/
   ...
   /*------------------------MED_MSG_CODE_BEGIN ---------------*/
    ...
    MSG_ID_MED_CAM_CODE_END = MSG_ID_MEDIA_CAM_START_MAV_STITCH_REQ,
...
/* ---- SKY_MULTIMEDIA start ---- */
    ...
    MSG_ID_MEDIA_CAM_MPCHAT_INIT_IND,   
    MSG_ID_MEDIA_CAM_MPCHAT_DATAREQ_IND,    
    MSG_ID_MEDIA_CAM_MPCHAT_DATARSP_IND,
    MSG_ID_MPCHAT_AUD_DATA_IND,  
#endif
/* ---- SKY_MULTIMEDIA end ---- */
/*------------------------MED_MSG_CODE_END -----------------*/
