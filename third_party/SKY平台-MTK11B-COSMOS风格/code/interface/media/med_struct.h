...
#define MEDIA_MTV_MBBMS_DESC_LENGTH (250 + 1)
...
typedef struct
{
    ...
    kal_uint32 parameter;       /**< event parameter which depends on what kind of event is sent */
    kal_wchar  desc[MEDIA_MTV_MBBMS_DESC_LENGTH];        /**< for description string */
...
{
    LOCAL_PARA_HDR
} media_cam_mr_data_req_struct;

typedef struct
{
    LOCAL_PARA_HDR
    kal_uint8* pData;
    kal_uint32 nDataSize;
    kal_uint32 nSrc;
    kal_uint32 nState;
} media_cam_mr_data_cnf_struct;
...
typedef struct
{
    ...
    kal_uint32 nSrc;
    kal_uint32 nState;
} mr_media_enc_data_ind_struct;

typedef struct
{
    LOCAL_PARA_HDR
    kal_uint8  result;
} mr_media_enc_data_cnf_struct;
...
typedef struct
{
    ...
    kal_uint16* pData;
    kal_uint32 nDataSize;
} mmi_media_aud_mr_data_ind_struct;
...
} media_cam_mav_capture_image_ready_ind_struct;
