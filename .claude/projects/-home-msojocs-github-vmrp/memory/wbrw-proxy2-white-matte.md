...
最终证据：`/tmp/vmrp-e2e-0crfJT/loaded.ppm` 的 `(100,43)` 为 framebuffer white `[248,252,248]`，蓝/红主体和最右字形仍在；缓存 `/tmp/vmrp-ws-51gaPf/mythroad/brw/http/cache3/6620.gif` 四角为 `[255,255,255,255]`，透明像素和纯黑像素均为 0。详见 `omx_wiki/wbrw-proxy2-white-matte-progress-2026-07-16.md`。
